...
## Table of Contents
1. [Today's Topics: Parallel Computers](#todays-topics-parallel-computers)
2. [Dependencies in Parallel Computing](#dependencies-in-parallel-computing)
3. [Parallel Loops](#parallel-loops)
4. [Loop Dependence](#loop-dependence)
5. [Compiler Optimization](#compiler-optimization)
6. [SIMD Overview](#simd-overview)
7. [Vector Processors](#vector-processors)
8. [Hardware Trends for Vectorization](#hardware-trends-for-vectorization)
9. [Code optimization for NEC SX-AT](#code-optimization-for-nec-sx-at)
10. [Shared-memory Computer](#shared-memory-computer)
11. [UMA Architecture](#uma-architecture)
12. [Shared Data](#shared-data)
13. [What is a Cache Memory?](#what-is-a-cache-memory)
14. [The principle of locality](#the-principle-of-locality)
15. [Message Collision](#message-collision)
16. [NUMA Architecture](#numa-architecture)
17. [Switch Networks](#switch-networks)
18. [Cache coherence in NUMA](#cache-coherence-in-numa)
19. [Distributed-Memory Computers](#distributed-memory-computers)
20. [Hybrid Systems](#hybrid-systems)
21. [Performance Metrics](#performance-metrics)
22. [Network Topology](#network-topology)
23. [Summary](#summary)
